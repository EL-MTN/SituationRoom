...
import { findFlightByCallsign, getFlightTrack } from '../services/opensky';
import type { FlightState, FlightPosition } from '../types/opensky.types';
import { FLIGHT_TRACKER_CONFIG } from '../constants/flighttracker.constants';
